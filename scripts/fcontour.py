...
fcontour('df_n-W=2,T=0.002.csv', savefig='fig-n.png', title=r'I-M path filling $n$ for $T = 0.002$, $D = 1$',
        log=False, color='jet', label=r'$n$')

# w = 0, log
fcontour('df_0-W=2,T=0.002.csv', savefig='fig-w0-log.png', title=r'I-M path $\rho(\omega=0)$ for $T = 0.002$, $D = 1$',
        log=True, color='jet', label=r'$\rho(\omega=0)$', trunc=1e-5)

# w = 0, lin
fcontour('df_0-W=2,T=0.002.csv', savefig='fig-w0-lin.png', title=r'I-M path $\rho(\omega=0)$ for $T = 0.002$, $D = 1$',
