...
## filling
#fcontour(sys.argv[1], savefig='mean-n.png', title=r'mean M-I and I-M of filling $n$ for $\mu = U/2$, $D = 1$',
#        log=False, color='jet', label=r'$n$')

# w = 0, log
fcontour(sys.argv[1], savefig='mean-rho_w0-log.png', title=r'mean M-I and I-M of $\rho(\omega=0)$ for $\mu = U/2$, $D = 1$',
        log=True, color='jet', label=r'$\rho(\omega=0)$', trunc=1e-5)

# w = 0, lin
fcontour(sys.argv[1], savefig='mean-rho_w0-lin.png', title=r'mean M-I and I-M of $\rho(\omega=0)$ for $\mu = U/2$, $D = 1$',
