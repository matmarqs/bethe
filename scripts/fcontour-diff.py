...
## filling
#fcontour(sys.argv[1], savefig='diff-n.png', title=r'difference I-M and M-I of filling $n$ for $T = 0.002$, $D = 1$',
#        log=False, color='jet', label=r'$n$')

# w = 0, log
fcontour(sys.argv[1], savefig='diff-rho_w0-log.png', title=r'difference M-I and I-M of $\rho(\omega=0)$ for $T = 0.002$, $D = 1$',
        log=True, color='jet', label=r'$\rho(\omega=0)$', trunc=1e-5)

# w = 0, lin
fcontour(sys.argv[1], savefig='diff-rho_w0-lin.png', title=r'difference M-I and I-M of $\rho(\omega=0)$ for $T = 0.002$, $D = 1$',
